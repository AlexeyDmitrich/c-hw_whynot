...
void Drunk1Glass (int anonimus, double swill){  // в круглых скобках указываем аргументы, это данные, которые должны быть переданы в метод при его вызове. 
// в данном случае - это int, подразумевающий живого человека (на месте Васи здесь может оказаться кто угодно с типом int)
// и double, подразумевающий выпивку. 
